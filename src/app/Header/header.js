...
export default function Header() {
    return (
        <header>
            <div className="top-bar bg-secondary-dark">
                <div className="w-100 h-100 d-flex align-items-center justify-content-between">
                    <ul className="list-unstyled m-0 mx-3 d-flex align-items-center p-2 cus-social-media">
                        <li className="mb-0">
                    ...
                    <ul className="list-unstyled m-0 d-flex align-items-center top-bar-menus">
                        <li className="top-bar-contact">
                            <a href="tel:(+1)8883168287" className="text-white text-uppercase">
                        ...
                        <li className="top-bar-carrers">
                            <a href="#" className="text-white text-uppercase">Careers</a>
                        </li>
                        <li className="top-bar-get-quote">
                            <a href="#" className="text-white text-uppercase">Get a Quote</a>
                        </li>
                    </ul>
                </div>
            </div>
